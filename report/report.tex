...
$X$, $Y$ and $Z$. These primaries can not been produced nor seen by the human
...
mixture of $X$, $Y$ and $Z$. Because $XYZ$ is a linear combination of $RGB$,
$XYZ$ inherrits all dependencies on the image conditions from $RGB$.
